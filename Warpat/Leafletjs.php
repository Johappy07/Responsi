...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Sumber data: <a href="https://bekasikota.bps.go.id"
                    target ="_blank">https://bekasikota.bps.go.id/</a></p>
                </div>
    ...
    <script>
        /* Initial Map */
        var map = L.map('map').setView([-1.03204, 130.50521], 6); //lat, long, zoom
    ...
    <?php
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                $lat = $row["latitude"];
                $long = $row["longitude"];
                echo "L.marker([$lat, $long]).addTo(map).bindPopup('kecamatan: $info');";
            } 
        }
        else {
            echo "0 results";
