...
<head>
    ...
    <title>Peta Penginapan Kabupaten Raja Ampat </title>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <i class >Peta Penginapan Kabupaten Raja Ampat</i> 
            </a>
...
<?php
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                $jam = $row["jam"];
                $rating = $row["rating"];
                echo "L.marker([$lat, $long]).addTo(map).bindPopup('Nama Objek Wisata: $info <br> Jenis Objek Wisata: $jenis <br> Lokasi Objek Wisata: $lokasi <br> Jam Operasional: $jam <br> Rating: $rating' );";
            } 
        }
        else {
            echo "0 results";
